...
export default function KnowledgeSection(props){
    return (
        <div className="w-full h-screen bg-black px-9 pt-20 " id="knowledge">
            ...
            <FSideKnowledge img="/images/html-css-img.jpg"
            alt="HTML e CSS"
            subject="HTML e CSS"
            />
             <FSideKnowledge img="/images/react-img.jpg"
            alt="React.js"
            subject="React.js"
            />
            <FSideKnowledge img="/images/mongod-img.jpg"
            alt="Mongodb"
            subject="Mongodb" />
            </div>
            <div>
            <SSideKnowledge img="/images/js-img.png"
            alt="Javascript"
            subject="Javascript"
            />
            <SSideKnowledge img="/images/node-img.jpg"
            alt="Node.js"
            subject="Node.js"
            />
            </div>
